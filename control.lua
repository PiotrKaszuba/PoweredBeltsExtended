...
function replace_entity(entity, surface, entity_idx, check_for_neighbour, power_up, underground_len, replace_context)
	...
	if replace_neighbour_first then
		n_lanes_items, n_lanes_positions, neighbour_entity = run_for_entity(neighbour_entity_before_replace, surface, neighbour_idx, false, underground_len, power_up, not power_up, replace_context)
